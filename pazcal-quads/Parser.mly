...
expr : T_int_const { (TYPE_int,$1,"") }
     ...
     | T_NOT expr { (check_is_bool (first_el $2) (rhs_start_pos 1), "test", third_el $2 with q_true = (third_el $2).q_false; q_false = (third_el $2).q_true ) }
     | T_not expr { (check_is_bool (first_el $2) (rhs_start_pos 1), "test", $2 with q_true = (third_el $2).q_false; q_false = (third_el $2).q_true ) } 
